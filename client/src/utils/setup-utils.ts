 ...
 */
export function generateConspiracyStatus(
...
export function pickConspiracyTarget(
...
export function generatePossibleConspiracyTargetId(
  ...
  return isConspiracy ? pickConspiracyTarget(playerIds, rng) : null;
}
